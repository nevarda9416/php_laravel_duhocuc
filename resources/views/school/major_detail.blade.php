                    ...
                    <div class="elementor-widget-wrap elementor-element-populated">
                        <div class="elementor-element elementor-element-80ef570 elementor-widget elementor-widget-heading elementor-align-left" data-id="80ef570" data-element_type="widget" data-widget_type="heading.default">
                            <div class="elementor-widget-container">
                                <h3 class="elementor-heading-title elementor-size-large">NHỮNG NGÀNH HỌC TẠI {{strtoupper($country->name??'')}}</h3>
                            </div>
                        </div>
                                ...
                                <div class="elementor-gallery__container">
                                    @if (!empty($categories->toArray()))
                                        @foreach ($categories as $category)
                                            <a class="e-gallery-item elementor-gallery-item elementor-animated-content" data-e-gallery-tags="2" href="{{ url('nganh-hoc/' . $slug . '/' . $category->slug) }}" data-elementor-open-lightbox="yes" data-elementor-lightbox-slideshow="all-c7ca10e"
