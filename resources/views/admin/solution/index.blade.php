...
<div class="row">
    ...
    <div class="col-md-8 col-sm-8 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br/>
                <form class="form-horizontal form-label-left input_mask" action="{{ url('solution/store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            ...
                            <div id="icon_preview" class="mt-4"></div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <textarea class="form-control editor_basic" name="excerpt" id="excerpt"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
