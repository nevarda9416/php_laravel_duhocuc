            ...
            <div class="elementor-column elementor-col-33 elementor-top-column elementor-element elementor-element-3339d72" data-id="3339d72" data-element_type="column">
                <div class="elementor-widget-wrap elementor-element-populated">
                    <div class="elementor-element elementor-element-c189633 elementor-widget elementor-widget-theme-site-logo elementor-widget-image" data-id="c189633" data-element_type="widget" data-widget_type="theme-site-logo.default">
                        <div class="elementor-widget-container">
                            <a href="{{ url('/') }}">
                                <img width="299" height="70" src="{{ asset('public/assets/images/logo/logo.png') }}" class="attachment-full size-full wp-image-12698" alt="Công ty tư vấn du học, công ty du học, trung tâm du học, trung tâm tư vấn du học"/> </a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="jet-menu-container">
                                    <div class="jet-menu-inner">
                                        <ul class="jet-menu jet-menu--animation-type-fade jet-menu--roll-up">
                                            ...
                                            <li id="jet-menu-item-20890" class="jet-menu-item jet-menu-item-type-post_type jet-menu-item-object-page jet-has-roll-up jet-simple-menu-item jet-regular-item jet-menu-item-20890"><a href="{{ url('goc-tu-van') }}" class="top-level-link">
                                                    <div class="jet-menu-item-wrapper">
                                            ...
                                            <li id="jet-menu-item-20890" class="jet-menu-item jet-menu-item-type-post_type jet-menu-item-object-page jet-has-roll-up jet-simple-menu-item jet-regular-item jet-menu-item-20890"><a href="{{ url('tuyen-dung') }}" class="top-level-link">
                                                    <div class="jet-menu-item-wrapper">
                                                        <div class="jet-menu-title">Tuyển dụng</div>
                                                    </div>
                                                </a></li>
                                            <li id="jet-menu-item-20890" class="jet-menu-item jet-menu-item-type-post_type jet-menu-item-object-page jet-has-roll-up jet-simple-menu-item jet-regular-item jet-menu-item-20890"><a href="{{ url('lien-he') }}" class="top-level-link">
                                                    <div class="jet-menu-item-wrapper">
