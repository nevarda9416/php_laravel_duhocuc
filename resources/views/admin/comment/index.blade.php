...
<div class="row">
    ...
    <div class="col-md-5 col-sm-5 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br/>
                <form class="form-horizontal form-label-left input_mask" action="{{ url('comment/store' . $queryString) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Nội dung bình luận <span
                                class="required">*</span></label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <textarea class="form-control" name="content" required="required" rows="8"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <div class="radio">
                                <input type="radio" checked="checked" value="pending" name="status" class="flat"> Chờ đăng
                            </div>
                            <div class="radio">
                                <input type="radio" value="publish" name="status" class="flat"> Cho phép đăng
                            </div>
                        </div>
                    </div>
